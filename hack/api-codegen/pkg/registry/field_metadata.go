...
var FieldRegistry = TypedFieldRegistry{
	"Cluster": {
		...
		"spec.hostedCluster.configuration.network.clusterNetwork": {
			FieldPath: "spec.hostedCluster.configuration.network.clusterNetwork",
			WriteMode: Immutable,
			OwnerType: "Cluster",
			OwnerGVK:  "hyperfleet.io/v1alpha1.Cluster",
		},
		"spec.hostedCluster.configuration.network.clusterNetwork.cidr": {
			FieldPath: "spec.hostedCluster.configuration.network.clusterNetwork.cidr",
			WriteMode: Immutable,
			OwnerType: "Cluster",
			OwnerGVK:  "hyperfleet.io/v1alpha1.Cluster",
		},
		"spec.hostedCluster.configuration.network.clusterNetwork.hostPrefix": {
			FieldPath: "spec.hostedCluster.configuration.network.clusterNetwork.hostPrefix",
			WriteMode: Immutable,
			OwnerType: "Cluster",
			OwnerGVK:  "hyperfleet.io/v1alpha1.Cluster",
		},
		"spec.hostedCluster.configuration.network.externalIP": {
			FieldPath: "spec.hostedCluster.configuration.network.externalIP",
			WriteMode: ServiceSet,
			Hidden:    true,
			OwnerType: "Cluster",
			OwnerGVK:  "hyperfleet.io/v1alpha1.Cluster",
		},
		"spec.hostedCluster.configuration.network.networkDiagnostics": {
			FieldPath: "spec.hostedCluster.configuration.network.networkDiagnostics",
			WriteMode: ServiceSet,
			Hidden:    true,
			OwnerType: "Cluster",
			OwnerGVK:  "hyperfleet.io/v1alpha1.Cluster",
		},
		"spec.hostedCluster.configuration.network.networkType": {
			FieldPath: "spec.hostedCluster.configuration.network.networkType",
			WriteMode: Immutable,
			OwnerType: "Cluster",
			OwnerGVK:  "hyperfleet.io/v1alpha1.Cluster",
		},
		"spec.hostedCluster.configuration.network.serviceNetwork": {
			FieldPath: "spec.hostedCluster.configuration.network.serviceNetwork",
			WriteMode: Immutable,
			OwnerType: "Cluster",
			OwnerGVK:  "hyperfleet.io/v1alpha1.Cluster",
		},
		"spec.hostedCluster.configuration.network.serviceNodePortRange": {
			FieldPath: "spec.hostedCluster.configuration.network.serviceNodePortRange",
			WriteMode: Mutable,
			OwnerType: "Cluster",
			OwnerGVK:  "hyperfleet.io/v1alpha1.Cluster",
		},
		...
		"spec.hostedCluster.networking.clusterNetwork.cidr": {
			FieldPath: "spec.hostedCluster.networking.clusterNetwork.cidr",
			WriteMode: Immutable,
			OwnerType: "Cluster",
			OwnerGVK:  "hyperfleet.io/v1alpha1.Cluster",
		},
		"spec.hostedCluster.networking.clusterNetwork.hostPrefix": {
			FieldPath: "spec.hostedCluster.networking.clusterNetwork.hostPrefix",
			WriteMode: Immutable,
			OwnerType: "Cluster",
			OwnerGVK:  "hyperfleet.io/v1alpha1.Cluster",
		},
		...
		"spec.hostedCluster.networking.machineNetwork.cidr": {
			FieldPath: "spec.hostedCluster.networking.machineNetwork.cidr",
			WriteMode: Immutable,
			OwnerType: "Cluster",
			OwnerGVK:  "hyperfleet.io/v1alpha1.Cluster",
		},
		...
		"spec.hostedCluster.networking.serviceNetwork.cidr": {
			FieldPath: "spec.hostedCluster.networking.serviceNetwork.cidr",
			WriteMode: Immutable,
			OwnerType: "Cluster",
			OwnerGVK:  "hyperfleet.io/v1alpha1.Cluster",
		},
	...
	"ClusterConfiguration": {
		...
		"network.clusterNetwork": {
			FieldPath: "network.clusterNetwork",
			WriteMode: Immutable,
			OwnerType: "ClusterConfiguration",
			OwnerGVK:  "",
		},
		"network.clusterNetwork.cidr": {
			FieldPath: "network.clusterNetwork.cidr",
			WriteMode: Immutable,
			OwnerType: "ClusterConfiguration",
			OwnerGVK:  "",
		},
		"network.clusterNetwork.hostPrefix": {
			FieldPath: "network.clusterNetwork.hostPrefix",
			WriteMode: Immutable,
			OwnerType: "ClusterConfiguration",
			OwnerGVK:  "",
		},
		"network.externalIP": {
			FieldPath: "network.externalIP",
			WriteMode: ServiceSet,
			Hidden:    true,
			OwnerType: "ClusterConfiguration",
			OwnerGVK:  "",
		...
		"network.networkDiagnostics": {
			FieldPath: "network.networkDiagnostics",
			WriteMode: ServiceSet,
			Hidden:    true,
			OwnerType: "ClusterConfiguration",
			OwnerGVK:  "",
		...
		"network.networkType": {
			FieldPath: "network.networkType",
			WriteMode: Immutable,
			OwnerType: "ClusterConfiguration",
			OwnerGVK:  "",
		},
		"network.serviceNetwork": {
			FieldPath: "network.serviceNetwork",
			WriteMode: Immutable,
			OwnerType: "ClusterConfiguration",
			OwnerGVK:  "",
		},
		"network.serviceNodePortRange": {
			FieldPath: "network.serviceNodePortRange",
			WriteMode: Mutable,
			OwnerType: "ClusterConfiguration",
			OwnerGVK:  "",
		},
	...
	"ClusterNetworkEntry": {
		"cidr": {
			FieldPath: "cidr",
			WriteMode: Immutable,
			OwnerType: "ClusterNetworkEntry",
			OwnerGVK:  "",
		},
		"hostPrefix": {
			FieldPath: "hostPrefix",
			WriteMode: Immutable,
			OwnerType: "ClusterNetworkEntry",
			OwnerGVK:  "",
		},
	...
	"ClusterNetworking": {
		...
		"clusterNetwork.cidr": {
			FieldPath: "clusterNetwork.cidr",
			WriteMode: Immutable,
			OwnerType: "ClusterNetworking",
			OwnerGVK:  "",
		},
		"clusterNetwork.hostPrefix": {
			FieldPath: "clusterNetwork.hostPrefix",
			WriteMode: Immutable,
			OwnerType: "ClusterNetworking",
			OwnerGVK:  "",
		},
	...
	"NetworkConfiguration": {
		"clusterNetwork": {
			FieldPath: "clusterNetwork",
			WriteMode: Immutable,
			OwnerType: "NetworkConfiguration",
			OwnerGVK:  "",
		},
		"clusterNetwork.cidr": {
			FieldPath: "clusterNetwork.cidr",
		...
		"serviceNodePortRange": {
			FieldPath: "serviceNodePortRange",
			WriteMode: Mutable,
			OwnerType: "NetworkConfiguration",
			OwnerGVK:  "",
		},
