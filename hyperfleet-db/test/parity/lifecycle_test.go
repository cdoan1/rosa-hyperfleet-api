...
func TestParity_FullReconcile(t *testing.T) {
	runOnBothBackends(t, func(t *testing.T, b *Backend) {
		...
		eventuallyCondition(t, b.Client,
			types.NamespacedName{Namespace: b.Namespace, Name: "alice"},
			fetched, reconcileTimeout,
			"status Ready",
			func() bool { return fetched.Status.Phase == "Ready" })
...
func TestParity_PolicyPrefix(t *testing.T) {
	runOnBothBackends(t, func(t *testing.T, b *Backend) {
		...
		fetched := &greeting.Greeting{}
		eventuallyCondition(t, b.Client,
			types.NamespacedName{Namespace: b.Namespace, Name: "bob"},
			fetched, reconcileTimeout,
			"status Ready",
			func() bool { return fetched.Status.Phase == "Ready" })
...
func TestParity_UpdateReReconciles(t *testing.T) {
	runOnBothBackends(t, func(t *testing.T, b *Backend) {
		...
		fetched := &greeting.Greeting{}
		eventuallyCondition(t, b.Client,
			types.NamespacedName{Namespace: b.Namespace, Name: "charlie"},
			fetched, reconcileTimeout,
			"status Ready",
			func() bool { return fetched.Status.Phase == "Ready" })
		...
		eventuallyCondition(t, b.Client,
			...
			fetched, reconcileTimeout,
			"status updated",
			func() bool { return fetched.Status.Message == "Hello, Charles!" })

		card := &greeting.GreetingCard{}
		eventuallyCondition(t, b.Client,
			types.NamespacedName{Namespace: b.Namespace, Name: "charlie-card"},
			card, reconcileTimeout,
			"card updated",
			func() bool { return card.Spec.Message == "Hello, Charles!" })
	})
}
...
func TestParity_OwnsTriggersReconcile(t *testing.T) {
	runOnBothBackends(t, func(t *testing.T, b *Backend) {
		...
		fetched := &greeting.Greeting{}
		eventuallyCondition(t, b.Client,
			types.NamespacedName{Namespace: b.Namespace, Name: "frank"},
			fetched, reconcileTimeout,
			"status Ready",
			func() bool { return fetched.Status.Phase == "Ready" })
