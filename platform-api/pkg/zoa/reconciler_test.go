...
func newFakeDB(t *testing.T, objs ...client.Object) *hyperfleetdb.Client {
	t.Helper()
	scheme := runtime.NewScheme()
	require.NoError(t, hyperfleetv1alpha1.AddToScheme(scheme))
	...
	return hyperfleetdb.NewClientFrom(builder.Build(), reconcilerLogger())
}

func jobStatus(t *testing.T, succeeded, failed int32, startTime, completionTime string) runtime.RawExtension {
	t.Helper()
			...
			ResourceStatuses: []hyperfleetv1alpha1.ResourceStatus{
				{
					...
					Name:      "zoa-exec-2",
					Namespace: "zoa-jobs",
					Status:    jobStatus(t, 1, 0, runnerStart, runnerComplete),
				},
				{
					Resource:  "jobs",
					Name:      "zoa-exec-2-upload",
					Namespace: "zoa-jobs",
					Status:    jobStatus(t, 1, 0, "", uploadComplete),
				},
			},
		},
	}
...
func TestReconcileExecution_DeletionFails(t *testing.T) {
	...
	hfm := &hyperfleetv1alpha1.Manifest{
		...
		Status: hyperfleetv1alpha1.ManifestStatus{
			Phase: hyperfleetv1alpha1.ManifestPhaseApplied,
			ResourceStatuses: []hyperfleetv1alpha1.ResourceStatus{
				{Resource: "jobs", Name: "zoa-exec-rb-fail", Status: jobStatus(t, 1, 0, "", "")},
				{Resource: "jobs", Name: "zoa-exec-rb-fail-upload", Status: jobStatus(t, 1, 0, "", "")},
			},
		},
	}
			...
			ResourceStatuses: []hyperfleetv1alpha1.ResourceStatus{
				{
					Resource: "jobs",
					Name:     "zoa-exec-1",
					Status:   jobStatus(t, 1, 0, start, runnerEnd),
				},
				{
					Resource: "jobs",
					Name:     "zoa-exec-1-upload",
					Status:   jobStatus(t, 1, 0, "", uploadEnd),
				},
			},
		},
	}
