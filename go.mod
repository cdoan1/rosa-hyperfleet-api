...
require (
	...
	github.com/jmelis/postgres-controller-backend v0.0.0-20260709174730-a505dbb1f9d2
	...
	github.com/typeid/hyperfleet-operator/api v0.0.0-20260710062344-d43119b5ecc9
